...
while(True):
    ...
    if k & 0xFF == ord('c') and bandera ==1:
        ...
        renglon2 = [colores[3],colores[4]]
        renglon3 = [colores[5],colores[6],colores[7]]
        ...
        colores=[renglon1[0],renglon1[1],renglon1[2],renglon2[0],renglon2[1],renglon3[0],renglon3[1],renglon3[2]]
        #print(colores)
